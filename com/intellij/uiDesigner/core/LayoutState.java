...
public final class LayoutState
{
  ...
  public LayoutState(GridLayoutManager layout, boolean ignoreInvisibleComponents)
  {
    ...
    this.myComponents = ((Component[])componentsList.toArray(new Component[0]));
    this.myConstraints = ((GridConstraints[])constraintsList.toArray(GridConstraints.EMPTY_ARRAY));
